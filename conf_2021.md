...
* ReAct: Out-of-distribution Detection With Rectified Activations `NIPS` `WR` `JRC`
	> A simple idea to identify OOD samples using penultimate-layers activations in pre-trained models. post-hoc ood method that requires gray-box access for trained models.
